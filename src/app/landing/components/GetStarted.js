...
export default function GetStarted() {
  ...
  return (
    <section className="py-24 px-6 bg-landing-surface-2">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-landing-orange/20 text-[#f97815] flex items-center justify-center font-bold">1</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-landing-orange/20 text-[#f97815] flex items-center justify-center font-bold">2</div>
                <div>
              ...
              <div className="flex gap-4">
                <div className="flex-none w-8 h-8 rounded-full bg-landing-orange/20 text-[#f97815] flex items-center justify-center font-bold">3</div>
                <div>
          ...
          <div className="flex-1 w-full">
            <div className="rounded-xl overflow-hidden bg-[#1e1e1e] border border-landing-border shadow-2xl">
              {/* Terminal header */}
