      ...
      <div className="relative w-full max-w-sm rounded-3.5 overflow-hidden shadow-elev fade-in flex flex-col bg-surface border border-border-subtle">
        ...
        <div className="px-7 py-7 pb-9 flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-2 text-center mt-2">
            <div className="w-14 h-14 rounded-3.5 flex items-center justify-center mb-1 bg-primary shadow-warm">
          ...
          <button
            ...
            className="w-full py-3 flex items-center justify-center gap-2 text-sm font-semibold text-white rounded-2.5 bg-primary hover:bg-primary-hover shadow-warm active:scale-[0.98] transition-all"
          >
