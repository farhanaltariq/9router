    ...
    <Card className="flex min-w-0 flex-col overflow-hidden" padding="sm" style={{ height: 480 }}>
      ...
      {!requests.length ? (
        ...
        <div className="flex-1 overflow-y-auto">
          <table className="w-full min-w-75 border-collapse text-xs">
              ...
              {requests.map((r, i) => {
                ...
                return (
                  <tr key={i} className="hover:bg-bg-subtle transition-colors">
                    ...
                    <td className="py-1.5 font-mono truncate max-w-30" title={r.model}>{r.model}</td>
...
export default function UsageStats({ period: periodProp, setPeriod: setPeriodProp, hidePeriodSelector = false } = {}) {
  ...
  const spinner = (
    <div className="flex items-center justify-center py-12 text-text-muted">
      <span className="material-symbols-outlined text-8 animate-spin">progress_activity</span>
    </div>
  );
    ...
    <div className="flex min-w-0 flex-col gap-6">
      ...
      {!hidePeriodSelector && (
        <div className="flex w-full items-center gap-2 sm:w-auto sm:self-end">
          ...
          {fetching && (
            <span className="material-symbols-outlined text-4 text-text-muted animate-spin">progress_activity</span>
          )}
        </div>
      )}
